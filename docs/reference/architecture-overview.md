...
| 文件 | 内容 |
|------|------|
| `scripts/chaoxing_config.json` | 共享配置 — 3 门课程、AI provider 选择 (doubao-api / deepseek-web)、session 名称、超时/重试参数 |
...
│   └─ 解析 passwords/doubao.txt → ARK_API_KEY + model
